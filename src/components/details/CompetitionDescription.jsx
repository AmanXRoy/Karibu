        ...
        <div className="productWrapper flex-1">
          <div className="productImage bg-[#ffa50080]">
            ...
            <div className="productBanner bg-[#FFA500] px-[42px] py-[58px] ">
              <p className='text-3xl font-semibold text-white flex justify-between items-start'>Toyota Double Cabin   <span className='text-center'>$ 8.00 <br /><span className='text-2xl text-center'>PER ENTRY</span></span></p>
            </div>
          </div>
        </div>
