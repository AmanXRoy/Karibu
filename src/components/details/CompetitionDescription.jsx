  ...
  return (
    <div>
      ...
      <div className="description flex gap-14 px-[100px]">
        ...
        <div className="productDetails flex-1 text-secondary-light border-[#C1B4B4] border-1 border-solid">
          <p className='text-3xl text-[#3F3836] font-semibold'>Landcruiser Toyota Double Cabin</p>
          <p className='text-2xl text-[#717171] font-medium my-[30px]'>The Landcruiser Toyota Double Cabin is renowned for its [key features: sleek design, powerful engine, advanced technology, luxurious interior]. Whether you're commuting to work or planning a weekend getaway, this car offers unmatched style, comfort, and performance.</p>
          <p className='text-2xl font-medium'><span className='font-semibold'>1.Engine Power: </span>[Highlight horsepower, engine type, etc.]</p>
          <p className='text-2xl font-medium'><span className='font-semibold' >1.Engine Power: </span>[Highlight horsepower, engine type, etc.]</p>
          <p className='text-2xl font-medium'><span className='font-semibold'>1.Engine Power: </span>[Highlight horsepower, engine type, etc.]</p>
          <p className='text-2xl font-medium'><span className='font-semibold'>1.Engine Power: </span>[Highlight horsepower, engine type, etc.]</p>
        </div>
